@extends('Home::layouts.master')  {{-- I. Load Master Layout --}}

@section('title', 'صفحه اصلی'){{-- II. Load Dynamic Title For Every Page --}}

@section('content'){{-- III. Insert <main> Tag Every Pages Here --}}

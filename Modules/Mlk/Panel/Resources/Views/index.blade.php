        ...
        <div class="row">
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card-box widget-user">
                    <div>
                        <div class="avatar-lg float-left mr-3">
                            <img src="{{asset('admin/images/users/user-1.jpg')}}" class="img-fluid rounded-circle" alt="کاربر">
                        </div>
                        <div class="wid-u-info">
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card-box widget-user">
                    <div>
                        <div class="avatar-lg float-left mr-3">
                            <img src="{{asset('admin/images/users/user-10.jpg')}}" class="img-fluid rounded-circle" alt="کاربر">
                        </div>
                        <div class="wid-u-info">
